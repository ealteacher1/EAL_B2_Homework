...
public static void main(String[] args) {
    ...
    String[] array1D_2 = obj.method8("FooBar");
    ...
    public int[][] method3() {
        System.out.println("Method 3 called without argument and with 2D array return.");
    ...
    public String[] method4(String str) {
        System.out.println("Method 4 called with argument: " + str + ", and with 1D array return.");
    ...
    public void method5() {
        System.out.println("Method 5 called without argument and return.");
    }

    // Method 6: With argument, no return
    public void method6(double num) {
        System.out.println("Method 6 called with argument: " + num + ", and no return.");
    }

    // Method 7: No argument, with return (2D array)
    public int[][] method7() {
        System.out.println("Method 7 called without argument and with 2D array return.");
    ...
    public String[] method8(String str) {
        System.out.println("Method 8 called with argument: " + str + ", and with 1D array return.");
        String[] array1D = {"Foo", "Bar"};
        return array1D;
    }

    // Method 9: No argument, no return
    public void method9() {
        System.out.println("Method 9 called without argument and return.");
    }

    // Method 10: With argument, no return
    public void method10(boolean flag) {
        System.out.println("Method 10 called with argument: " + flag + ", and no return.");
    }

    // Method 11: No argument, with return (2D array)
    public int[][] method11() {
        System.out.println("Method 11 called without argument and with 2D array return.");
    ...
    public String[] method12(String str) {
        System.out.println("Method 12 called with argument: " + str + ", and with 1D array return.");
