...
public class S47_MethodT4_NO_1 {
	...
	int sumResult = addition(5,10);//PLACING THE ARGUMENTS INSIDE THE PARAMETER
	...
	String newString = concatenateStrings ("Hello","World");//REMEMBER CONCATINATION RULES IS APPLYING HERE
	...
	public static int addition(int a, int b) {// INT "SUM" - SO RETURN WILL SAME AS "SUM"
		int sum = a+b;
		return sum;
